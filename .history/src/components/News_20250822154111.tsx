...
import { faBookmark as BookmarkRegular } from "@fortawesome/free-solid-svg-icons";
...
const News: React.FC = () => {
  ...
  useEffect(() => {
    const fetchNews = async()=>{
      let url = `https://gnews.io/api/v4/top-headlines?category=${selecetedCategory}&lang=en&apikey=41415ac5a21e545c848ba15afe3ed74f`

      if(searchQuery){
        url = `https://gnews.io/api/v4/search?q=${searchQuery}&lang=en&apikey=41415ac5a21e545c848ba15afe3ed74f`
      }
